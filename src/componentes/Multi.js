...
const MegaSena = props => {
  ...
  return (
    <View style={StyleMega.container}>
      ...
      <View style={StyleMega.mtop}>
        <Button title="Gerar Numero" onPress={() => updateNumerosGerados()} />
        <Button
          color="#f194ff"
          title="Gerar Numero Odernado"
          onPress={() => updateNumerosGerados(true)}
        />
      </View>
    </View>
  );
